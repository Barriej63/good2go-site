    ...
    <header className="border-b border-zinc-200 bg-white/80 backdrop-blur">
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-6">
        <Link href="/" className="flex items-center gap-3 font-semibold">
          <Image src="/logo-color.svg" alt="Good2Go" width={28} height={28} />
          <span>Good2Go</span>
        </Link>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <Link href="/contact" className="hidden sm:inline-flex items-center rounded-xl border border-zinc-300 px-4 py-2 text-sm hover:bg-zinc-50">Request Demo</Link>
        </div>
      </div>
    </header>
  );
