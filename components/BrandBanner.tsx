...
export default function BrandBanner() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-900 p-6 sm:p-8">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 [mask-image:radial-gradient(60%_50%_at_0%_0%,black,transparent)] bg-[radial-gradient(600px_300px_at_0%_0%,rgba(99,102,241,.18),transparent)]"
      />
    </div>
  );
}
