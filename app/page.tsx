...
<section id="our-solution" className="mt-16 lg:mt-24">
  <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8">
    ...
    <p className="mt-3 text-slate-600 leading-relaxed">
      Monitor patients with Good2Go&apos;s Dual-task Gait assessment.  Patients and Healthcare Practitioners can then <strong>view the results of the 
    ...
    <p className="mt-3 text-slate-600 leading-relaxed">
  It’s important to get the professional help you need to heal after a
  concussion. Good2Go&apos;s Dual-task Gait assessment aids the healthcare
  practitioner to apply multidisciplinary interventions to help you recover
  sooner.
</p>
